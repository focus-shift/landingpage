...
Zu _Mein Kundenportal_ gelangst du über _[focus-shift.de](https://focus-shift.de)_ > _Login_ und nach erfolgreichem Login über die Kachel _Mein Kundenportal_.
...
1. Unter Anwendungsinformation bei _Anwendungsname_ z. B. _focus-shift.de_ verwenden
...
2. Als _Name_ kann z.B. _focus-shift-de_ verwendet werden
...
Dazu muss man nun zu _Mein Kundenportal_ von [focus-shift.de](https://focus-shift.de) via _Login_ und über die Kachel
...
3. Ein Klick auf _speichern_ konfiguriert nun die Anbindung von focus-shift.de zu Google Workspace.
...
den Eintrag _focus-shift-de_ anklicken:
...
focus-shift.de via Google Workspace erfolgen.
Dazu öffnest du _[focus-shift.de](https://focus-shift.de)_ > _Login_, gibst deine E-Mail ein, klickst auf _Weiter_.
...
1. Durch einen Klick auf _Zu einem bestehenden Benutzerkonto hinzufügen_ weist du den
   Authentifizierungsserver von focus-shift.de an, dass du das Google Workspace Konto mit dem
...
Nun hast du erfolgreich die Integration von Google Workspace und focus-shift.de durchgeführt.

Die Verknüpfung des Kontos von focus-shift.de und Google Workspace erfolgt nur für deinen Benutzer bzw.
für Benutzer, welche _vor_ der Integration mit Google Workspace Zugriff auf focus-shift.de haben.
